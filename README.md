...
## 👋 САФАРОВ НУРЛАН — РАЗРАБОТЧИК НА С И C++ ИЗ РОССИИ
...
-   📚 ПАРАЛЛЕЛЬНО ПИШУ **СОБСТВЕННЫЕ КОНТЕЙНЕРЫ STL**
...
| **ВИРТУАЛЬНАЯ МАШИНА НА С** | НА ДАННЫЙ МОМЕНТ ВРЕМЕНИ РЕАЛИЗОВАН ПРОСТОЙ ПРОТОТИП СТЕКОВОЙ ВИРТУАЛЬНОЙ МАШИНЫ. ПЛАНОВОВАЯ ДАТА ЗАВЕРШЕНИЯ ПРОЕКТА — ЛЕТО 2027 ГОДА  |
