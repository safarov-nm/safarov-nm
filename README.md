...
## 👋 САФАРОВ НУРЛАН — РАЗРАБОТЧИК НА С И C++
...
-   📚 ПАРАЛЛЕЛЬНО ПИШУ **СОБСТВЕННЫЕ** КОНТЕЙНЕРЫ
-   💡СТРЕМЛЮСЬ К НАПИСАНИЮ **ЧИСТОГО**, **ПОДДЕРЖИВАЕМОГО** И **ЭФФЕКТИВНОГО** КОДА
-   🎓 УЧУСЬ НА **1-ОМ** КУРСЕ **МАГИСТРАТУРЫ** В ННГУ ИМЕНИ Н. И. ЛОБАЧЕВСКОГО ПО НАПРАВЛЕНИЮ **«ПРОГРАММНАЯ ИНЖЕНЕРИЯ»**  (2025-2027 гг.). 
ОБРАЗОВАНИЕ — ВЫСШЕЕ ПРОФЕССИОНАЛЬНОЕ С ОТЛИЧИЕМ: **БАКАЛАВРИАТ** ПО НАПРАВЛЕНИЮ **«ФУНДАМЕНТАЛЬНАЯ ИНФОРМАТИКА И ИНФОРМАЦИОННЫЕ ТЕХНОЛОГИИ»** (2021-2025 гг.)
- 🔭 ИНТЕРЕСЫ ВНЕ ПРОГРАММИРОВАНИЯ: ТЕОРЕТИЧЕСКАЯ ФИЗИКА (КОСМОЛОГИЯ), СПОРТИВНЫЙ БАДМИНТОН, ЭТИЧНЫЙ ХАКИНГ, ВЫСШАЯ МАТЕМАТИКА
---
...
| ПРОЕКТ | ОПИСАНИЕ |
|--------|----------|
| **СБОРЩИК МУСОРА НА C** | ПОЛНОЦЕННЫЙ СБОРЩИК МУСОРА, ОСНОВАННЫЙ НА АЛГОРИТМЕ ПРЕДВАРИТЕЛЬНОГО ПОМЕЧАНИЯ И ОЧИСТКИ — ЭФФЕКТИВНО ИДЕНТИФИЦИРУЕТ И ОСВОБОЖДАЕТ НЕИСПОЛЬЗУЕМУЮ ПАМЯТЬ, РАЗДЕЛЯЯ ПРОЦЕСС НА ЭТАПЫ МАРКИРОВКИ ДОСТИЖИМЫХ ОБЪЕКТОВ И ОЧИСТКИ НЕДОСТИЖИМЫХ 
| **ВИРТУАЛЬНАЯ МАШИНА НА С** | НА ДАННЫЙ МОМЕНТ ВРЕМЕНИ РЕАЛИЗОВАН ПРОСТОЙ ПРОТОТИП СТЕКОВОЙ ВИРТУАЛЬНОЙ МАШИНЫ. ПЛАНОВАЯ ДАТА ЗАВЕРШЕНИЯ ПРОЕКТА — ЛЕТО 2027 ГОДА  |
| **КОНТЕЙНЕРЫ STL** | САМОПИСНЫЕ РЕАЛИЗАЦИИ ПОПУЛЯРНЫХ СТРУКТУР ДАННЫХ (В ПРОЦЕССЕ)
---

### 📊 РАСШИРЕННАЯ СТАТИСТИКА GITHUB

<div align="center">
  <table>
    <tr>
      <td align="left" width="50%">
        <img src="http://github-profile-summary-cards.vercel.app/api/cards/stats?username=safarov-nm&theme=swift" alt="Общая статистика" />
      </td>
    </tr>
    <tr>
      <td align="right" width="50%">
        <img src="http://github-profile-summary-cards.vercel.app/api/cards/productive-time?username=safarov-nm&theme=swift&utcOffset=8" alt="Продуктивное время" />
      </td>
    </tr>
  </table>
</div>
